...
contraction_av = 1 - math.pow(3.520E-8 * ((mass_fraction * 100)), 3) + math.pow(1.027E-6 * ((mass_fraction * 100)),
                                                                                2) + 2.5E-4 * (
                             mass_fraction * 100) - 1.691E-4
...
alpha = 1 - mass_fraction + (a * b * mass_fraction * (1 - mass_fraction)) / (
